...
@section('content')
@php
    $featureImagePath = public_path('assets/images/feature-study-plan.png');
    $featureImageUrl = asset('assets/images/feature-study-plan.png').(is_file($featureImagePath) ? '?v='.filemtime($featureImagePath) : '');
@endphp
<div class="feature-workspace feature-plan">
    <section class="feature-page-hero animate-fade-up">
        <div>
            <span class="feature-kicker"><i class="bi bi-calendar-check"></i> Study Plan</span>
            <h1>Susun rencana belajar yang lebih terarah</h1>
            <p>Masukkan materi atau upload dokumen, lalu AI menyusun langkah belajar bertahap agar persiapan lebih rapi.</p>
        </div>
        <div class="feature-hero-card" aria-label="Rencana Belajar">
            <div class="feature-hero-visual">
                <span class="feature-hero-ring"></span>
                <img class="feature-hero-robot" src="{{ $featureImageUrl }}" alt="Ilustrasi Study Plan" onerror="this.onerror=null;this.src='{{ asset('assets/icons/fallback-illustration.svg') }}';">
                <span class="feature-hero-chip chip-top"><i class="bi bi-calendar3"></i> Jadwal belajar</span>
                <span class="feature-hero-chip chip-bottom"><i class="bi bi-list-check"></i> Langkah bertahap</span>
            </div>
    ...
    <div class="col-lg-5">
        <div class="card p-4 feature-panel">
            <div class="section-title mb-3">
                <span class="icon-box" style="background:rgba(245,158,11,.1); color:var(--warning);"><i class="bi bi-calendar-check"></i></span>
                AI Rencana Belajar
            </div>
            <p style="color:var(--text-muted); font-size:.85rem;">Ketik materi manual atau upload file (PDF, DOCX, TXT, gambar), lalu buat jadwal belajar otomatis.</p>
        ...
        <div class="card d-flex flex-column feature-panel feature-result-panel" style="min-height:620px;">
            ...
            <div class="flex-grow-1 overflow-auto p-3" id="chatArea" style="min-height:380px; max-height:460px; background:var(--surface-alt);">
                <div class="text-center py-5" style="color:var(--text-muted);">
                    <i class="bi bi-calendar-check fs-1 d-block mb-3" style="opacity:.3;"></i>
                    <b style="color:var(--text);">Rencana belajar siap dibuat</b><br>
                    <div class="small mt-2" style="max-width:300px; margin:0 auto;">
                        1. Ketik/Upload materi di panel sebelah kiri.<br>
                        2. Klik "Rencana Belajar" di bawah, atau langsung ketik pertanyaan Anda!
                    </div>
                </div>
            </div>
            ...
            <div class="p-3" style="border-top:1px solid var(--border);">
                ...
                <div class="d-flex flex-wrap gap-2 mb-3" id="quickActions">
                    <button class="btn btn-sm btn-outline-warning rounded-pill fw-bold" onclick="triggerPlan()" id="btnPlan" style="color:var(--warning); border-color:var(--warning);">
