...
@section('content')
@php
    $featureImagePath = public_path('assets/images/feature-summarizer.png');
    $featureImageUrl = asset('assets/images/feature-summarizer.png').(is_file($featureImagePath) ? '?v='.filemtime($featureImagePath) : '');
@endphp
<div class="feature-workspace feature-summarize">
    <section class="feature-page-hero animate-fade-up">
        <div>
            <span class="feature-kicker"><i class="bi bi-stars"></i> AI Summarizer</span>
            <h1>Ringkas materi jadi inti yang mudah dipahami</h1>
            <p>Masukkan catatan atau upload file, lalu AI akan menyusun ringkasan, poin penting, istilah kunci, dan kesimpulan.</p>
        </div>
        <div class="feature-hero-card" aria-label="Ringkasan Materi">
            <div class="feature-hero-visual">
                <span class="feature-hero-ring"></span>
                <img class="feature-hero-robot" src="{{ $featureImageUrl }}" alt="Ilustrasi AI Summarizer" onerror="this.onerror=null;this.src='{{ asset('assets/icons/fallback-illustration.svg') }}';">
                <span class="feature-hero-chip chip-top"><i class="bi bi-file-text"></i> Ekstrak poin</span>
                <span class="feature-hero-chip chip-bottom"><i class="bi bi-stars"></i> Ringkasan rapi</span>
            </div>
            <div class="feature-hero-meta">
                <span>Fokus halaman</span>
                <b>Ringkasan Materi</b>
            </div>
        </div>
    </section>
    ...
    <div class="col-lg-5">
        <div class="card p-4 feature-panel">
            <div class="section-title mb-3">
                <span class="icon-box" style="background:rgba(79,70,229,.1); color:var(--primary);"><i class="bi bi-stars"></i></span>
                AI Ringkasan
            </div>
            <p style="color:var(--text-muted); font-size:.85rem;">Ketik materi manual atau upload file (PDF, DOCX, TXT, gambar), lalu buat ringkasan yang rapi.</p>
        ...
        <div class="card d-flex flex-column feature-panel feature-result-panel" style="min-height:620px;">
            ...
            <div class="flex-grow-1 overflow-auto p-3" id="chatArea" style="min-height:380px; max-height:460px; background:var(--surface-alt);">
                <div class="text-center py-5" style="color:var(--text-muted);">
                    <i class="bi bi-stars fs-1 d-block mb-3" style="opacity:.3;"></i>
                    <b style="color:var(--text);">Ringkasan siap dibuat</b><br>
                    <div class="small mt-2" style="max-width:300px; margin:0 auto;">
                        1. Ketik/Upload materi di panel sebelah kiri.<br>
                        2. Klik "Ringkas Materi" di bawah, atau tanyakan bagian yang belum dipahami.
                    </div>
                </div>
            </div>
            ...
            <div class="p-3" style="border-top:1px solid var(--border);">
                ...
                <div class="d-flex flex-wrap gap-2 mb-3" id="quickActions">
                    <button class="btn btn-sm btn-outline-primary rounded-pill fw-bold" onclick="triggerSummarize()" id="btnSummarize">
                        <i class="bi bi-stars"></i> Ringkas Materi
                    </button>
                </div>
